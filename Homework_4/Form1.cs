...
namespace Homework_4
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Pen penGreen = new Pen(Color.Yellow, 1);
        public Pen penRed = new Pen(Color.Black, 1);
        public Pen penPurple = new Pen(Color.Blue, 1);
        public Pen penOrange = new Pen(Color.Purple, 1);
        public int lambda=1;
